...
extension GameDescriptor {
    ...
    static let insurgency = GameDescriptor(
        ...
        tagline: "Tactical co-op and close-quarters firefights.",
        symbol: "scope",
        steamAppID: "222880",
    ...
    static let supremeCommander = supremeCommanderProfile(
        ...
        tagline: "Command vast armies across land, air, and sea.",
        steamAppID: "9350",
    ...
    static let forgedAlliance = supremeCommanderProfile(
        ...
        tagline: "A standalone expansion for sprawling strategic war.",
        steamAppID: "9420",
        executable: "SupremeCommander.exe",
        installExecutable: "bin/SupremeCommander.exe",
    ...
    static let angelsFallFirst = GameDescriptor(
        ...
        tagline: "Infantry, armor, starfighters, and capital ships in one battle.",
        symbol: "airplane",
        steamAppID: "367270",
    ...
    static let battlefront2Classic = GameDescriptor(
        ...
        tagline: "Campaigns, instant action, and combined-arms battles.",
        symbol: "star.fill",
        steamAppID: "6060",
